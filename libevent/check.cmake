...
if (DEFINED ENV{SPEED_UP_URL})
    set(_DEP_URL $ENV{SPEED_UP_URL}/${_DEP_NAME}-release-${_DEP_VER}-stable.tar.gz)
else ()
...
set(_DEP_NAME_BUILD_CHECK ${_DEP_NAME}.a)
if ((${_NEED_REBUILD}) OR (NOT EXISTS ${_DEP_PREFIX}/lib/${_DEP_NAME_BUILD_CHECK}))
    DownloadDep()
    ExtractDep()
