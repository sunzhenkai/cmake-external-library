...
function(CleanDep)
    ...
    if (NOT ${_DEP_CUR_DIR} STREQUAL "")
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/bin)
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/lib)
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/src)
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/build)
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/include)
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/share)
        file(REMOVE_RECURSE ${_DEP_CUR_DIR}/doc)
    endif ()
endfunction()
